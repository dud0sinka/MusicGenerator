...
class DrumsDefaultMelodicBreakdown:
    def __init__(self, start_pos):
        ...
        self.kick = Kick(start_pos, self.kicks_generated)
    ...
    def generate(self, file, data, kick_list):
        ...
        for repetition in range(repetitions):
            ...
            kick_snare = self.generate_kick_and_snare(repetition, bars, file, kick_list, fill_flag)
    ...
    def generate_kick_and_snare(self, repetition, bars, file, kick_list, fill_flag=0):
